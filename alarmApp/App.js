    ...
    <View style={styles.alarmBody}>
      ...
      <View style={styles.alarm}>
        ...
        >
          ...
          <Text style={{color:'#fff', fontSize:18, marginTop:12, marginRight:35}}>:</Text>
        <Picker
          style={{ height: 50, width: 100, color:'#fff' }}
        ...
        >
          ...
          <View style={{flexDirection:'row', marginRight:22, marginTop:10}}>
            <TouchableOpacity style={{marginRight:15}} onPress={() => days.push(0)}><Text style={{fontSize:20, color:"#fff"}}>S</Text></TouchableOpacity>
            <TouchableOpacity style={{marginRight:15}} onPress={() => days.push(1)}><Text style={{fontSize:20, color:"#fff"}}>M</Text></TouchableOpacity>
            <TouchableOpacity style={{marginRight:15}} onPress={() => days.push(2)}><Text style={{fontSize:20, color:"#fff"}}>T</Text></TouchableOpacity>
            <TouchableOpacity style={{marginRight:15}} onPress={() => days.push(3)}><Text style={{fontSize:20, color:"#fff"}}>W</Text></TouchableOpacity>
            <TouchableOpacity style={{marginRight:15}} onPress={() => days.push(4)}><Text style={{fontSize:20, color:"#fff"}}>Th</Text></TouchableOpacity>
            <TouchableOpacity style={{marginRight:15}} onPress={() => days.push(5)}><Text style={{fontSize:20, color:"#fff"}}>F</Text></TouchableOpacity>
            <TouchableOpacity style={{marginRight:15}} onPress={() =>{ days.push(6); }}><Text style={{fontSize:20, color:"#fff"}}>Sa</Text></TouchableOpacity>
          </View>
